    ...
    return (
        <section id="intro">    
            <div className="introContent">
                ...
                <p className="introPara">I am a skilled software developer with a good understanding of design<br /> principles and patterns that I can apply to create robust softwares.</p>
